...
mysqli_set_charset($link,"utf8");
	...
	if(!isset($id)){
		header("Location:entrar.php");
			...
			$sql = "SELECT distinct nome,email,data,hora,ip FROM leads ";
			...
			while($row = mysqli_fetch_assoc($result)) {
              ...
              $adicionar_lead = "INSERT INTO leads2 (nome,email,data,ip) VALUES('".$row["nome"]."','".$row["email"]."','".date("Y-m-d G:i:s", $d)."','".$row["ip"]."')";
